...
import '../instragram_kalone/comment/comment_screen.dart';
import '../instragram_kalone/model_class/model.dart';

class ReelsScreen extends StatefulWidget {
  final String videoId;
  const ReelsScreen({super.key, required,required this.videoId });
...
// Profile, Username, Follow button, and Video description
          Positioned(
            left: 16.0,
            bottom: 20.0,
            child: Column(
                ...
                Row(
                  children: [
                    ...
                    if (widget.followers
                      ...
                      OutlinedButton(
                        onPressed: () {
                          widget.userController.addToFollowing(widget.authorId);
                        },
                        child: Text(
                          "Follow",
